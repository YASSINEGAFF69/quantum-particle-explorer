...
class QuantumParticleAnimation {
  ...
  setupEventListeners() {
    ...
    // Preset buttons
    document
      .getElementById("cosmicPreset")
      .addEventListener("click", () => this.setPreset("cosmic"));
    document
      .getElementById("matrixPreset")
      .addEventListener("click", () => this.setPreset("matrix"));
    document
      .getElementById("firefliesPreset")
      .addEventListener("click", () => this.setPreset("fireflies"));
    document
      .getElementById("rainbowPreset")
      .addEventListener("click", () => this.setPreset("rainbow"));
    ...
    document
      ...
      .addEventListener("click", () => this.triggerExplosion());
    ...
    document
      .getElementById("entanglementBtn")
      .addEventListener("click", () => this.quantumEntanglement());
  ...
  animate() {
    ...
    for (let particle of this.particles) {
      ...
      if (this.timeDilationActive) {
        const distanceToCenter = Math.hypot(particle.x - centerX, particle.y - centerY);
    ...
    if (this.searchTarget) {
      ...
      this.ctx.arc(
        this.searchTarget.x,
        this.searchTarget.y,
        this.searchTarget.radius + pulse,
        0,
        Math.PI * 2
      );
